...
class ControllerTests  {
    ...
    public void givenId_CreditAndThenDebit_thenReturnJson() {
        ...
        doAnswer(invocation -> {
            ...
            return "OK";
        }).when(service).creditAccount(account.getAccountNumber(),1000.0);

        doAnswer(invocation -> {
            account.post(new WithdrawalTransaction(50.0));
            return "OK";
        }).when(service).debitAccount(account.getAccountNumber(),50.0);
    ...
    public void givenId_CreditAndThenDebitMoreGetException_thenReturnJson()
        ...
        }).when(service).debitAccount(account.getAccountNumber(),5000.0);
